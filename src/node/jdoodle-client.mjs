...
const rawExecute = ({
  url = process.env.JDOODLE_EXECUTE_ENDPOINT || lib.defaults.executeEndpoint,
  clientId = process.env.JDOODLE_CLIENT_ID,
  clientSecret = process.env.JDOODLE_CLIENT_SECRET,
  language = lib.defaults.language,
  versionIndex = lib.defaults.versionIndex,
  stdin = lib.defaults.stdin,
  script = lib.defaults.script
} = {}) => _api(url, {
  clientId,
  clientSecret,
  language,
...
const rawCreditSpent = ({
  url = process.env.JDOODLE_CREDIT_SPENT_ENDPOINT || lib.defaults.creditSpentEndpoint,
  clientId = process.env.JDOODLE_CLIENT_ID,
  clientSecret = process.env.JDOODLE_CLIENT_SECRET
} = {}) => _api(url, {
  clientId,
